...
If the user explicitely says that you can write several tests at once do it, but needs to be hyperclear that is asking for that, dont interpret their words.
